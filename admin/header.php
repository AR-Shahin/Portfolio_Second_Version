            ...
            <ul class="nav top-menu">
                ...
                <li id="header_notification_bar" class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        ...
                        <span class="badge badge-warning"><?= Services::countServices()?></span>
                    </a>
    ...
    <aside>
        <div id="sidebar"  class="nav-collapse ">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    <a href="javascript:;" <?= $page == 'addservice.php' ? 'class="active"' : '' ?> <?= $page == 'manageservice.php' ? 'class="active"' : '' ?> >
                        <i class="fa fa-briefcase"></i>
                        <span>Services</span>
                    </a>
                    <ul class="sub">
                        <li <?= $page == 'addservice.php' ? 'class="active"' : '' ?>><a  href="addservice.php" >Add Service</a></li>
                        <li <?= $page == 'manageservice.php' ? 'class="active"' : '' ?>><a  href="manageservice.php">Manage Service</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
