...
if(isset($_POST['login-btn']) && $_SERVER["REQUEST_METHOD"] == "POST"){
    $ob = new \App\classes\Login();
    $login = $ob->loginCheck($_POST);
    if($login == true){
        echo 'ok';
    }
...
<div class="container">
    ...
    <form class="form-signin" action="" method="post">
        ...
        <div class="login-wrap">
            <span style="color: red;"><?= $sob->get('emptyUser')?></span>
            <input type="text" class="form-control" placeholder="User name" autofocus name="username">
            <span style="color: red;"><?= $sob->get('emptyPass')?></span>
            ...
            <span style="color: red;"><?= $sob->get('invaliduser')?></span>
        </div>
    </form>
...
<?php
$sob->unsetSession('emptyUser');
$sob->unsetSession('emptyPass');
$sob->unsetSession('invaliduser');
?>